...
function generateSong(event) {
  ...
  let context =
    "You are a great songwriter and love to write catchy songs. Your mission is to generate a 4-strophe song in basic HTML and separate each strophe with a <br />. Make sure to follow the user instructions.";
